...
import 'package:bangumi/bean/card/bangumi_info_card.dart';
...
import 'package:bangumi/request/query_manager.dart';
                  ...
                  SmartDialog.show(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content: const Text('您想要离开 bangumi 并在浏览器中打开此视频源吗？'),
                          actions: [
                            TextButton(
                                onPressed: () {
                                  SmartDialog.dismiss();
